...
export const metadata = {
  title: process.env.NEXT_PUBLIC_APP_NAME ?? 'Namviek Python Rebuild Demo',
  description:
    'An unofficial learning demo that rebuilds the Namviek backend with Python and FastAPI'
}
