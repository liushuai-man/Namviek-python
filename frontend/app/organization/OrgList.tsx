      ...
      {[1, 2, 3].map(item => {
        return (
          <motion.div
            ...
            <div className="animate-pulse w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-md" />
            <div className="flex flex-col gap-1 text-zinc-700 dark:text-zinc-400">
              <h2 className="font-medium bg-gray-100 h-[15px] w-[100px] dark:bg-gray-700 rounded-md animate-pulse text-transparent">
                No title
              </h2>
              <small className="text-xs h-[10px] w-[70px] animate-pulse text-transparent bg-gray-100 dark:bg-gray-700 rounded-md">
                No title
              </small>
            </div>
          </motion.div>
          ...
          {!loading &&
            orgs.map(org => {
              const createdAt = org.createdAt
                ? formatDistanceToNowStrict(new Date(org.createdAt), {
                    addSuffix: true
                  })
                : null
              return (
                <Link
                  ...
                  <motion.div
                    ...
                    <div className="flex flex-col text-zinc-700 dark:text-zinc-400">
                      ...
                      <small className="text-xs text-zinc-400 dark:text-zinc-600">
                        {createdAt}
                      </small>
                    </div>
                  </motion.div>
