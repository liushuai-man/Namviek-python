...
from app.api.routes.frontend_compat import router as compat_router
...
from app.core.middleware import CorsMiddleware, SecurityHeadersMiddleware
...
def create_app() -> FastAPI:
    ...
    application.include_router(compat_router, prefix="/api", include_in_schema=False)
    return application
